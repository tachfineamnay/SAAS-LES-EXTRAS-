                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-600 mt-1">
                                Confirmez les heures pour clôturer l&apos;intervention.
                            </p>
                        </div>
                    </div>
                    <Button
                        className="w-full sm:w-auto bg-amber-600 hover:bg-amber-700 text-white border-none"
                        onClick={() => handleValidate(booking.relatedBookingId ?? booking.lineId)}
                        disabled={loadingId === (booking.relatedBookingId ?? booking.lineId)}
                    >
                        {loadingId === (booking.relatedBookingId ?? booking.lineId) ? (
